...
(function (h) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "Нет созданных комнат",
            sInfo: "Отображаются с _START_ по _END_ из _TOTAL_ записей",
            sInfoEmpty: "Отображаются с 0 по 0 из 0 записей",
            sInfoFiltered: "(filtered from _MAX_ total записей)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Отображать на одной странице _MENU_ записей",
            sLoadingRecords: "Загрузка...",
            sProcessing: "Загрузка...",
            sSearch: "Поиск:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Не найдено совпадений..."
        },
        oSearch: h.extend({},
            n.models.oSearch),
        sAjaxDataProp: "data",
